...
export const priceProviderAddress = "0x0F89ba3F140Ea9370aB05d434B8e32fDf41a6093" as const;
...
export const outputReceiverAddress = "0x8f74c989252B94Fd2d08a668884D303D57c91422" as const;
...
export const tokenVaultABI = [
    ...
    },
    {
        ...
        inputs: [{ name: "fnftId", internalType: "uint256", type: "uint256" }],
        name: "getFNFTAddress",
        outputs: [{ name: "smartWallet", internalType: "address", type: "address" }],
    },
    {
        stateMutability: "view",
        type: "function",
...
export const tokenVaultAddress = "0xD672f1E3411c23Edbb49e8EB6C6b1564b2BF8E17" as const;
...
export const fnftHandlerAddress = "0xa07E6a51420EcfCB081917f40423D29529705e8a" as const;
...
export const reduxABI = [
    {
        "inputs": [
            { "internalType": "contract ERC20", "name": "_asset", "type": "address" },
            { "internalType": "address", "name": "_depositAddress", "type": "address" },
    ...
    {
        "inputs": [{ "internalType": "uint256", "name": "depositCap", "type": "uint256" }],
    ...
    },
    {
        ...
        "inputs": [
            { "indexed": true, "internalType": "address", "name": "owner", "type": "address" },
            { "indexed": true, "internalType": "uint256", "name": "assets", "type": "uint256" },
        ],
        "name": "DepositRequestProcessed",
        "type": "event",
    },
    {
        "anonymous": false,
    ...
    {
        "anonymous": false,
        "inputs": [{ "indexed": false, "internalType": "address", "name": "newGovController", "type": "address" }],
        "name": "GovernanceControllerChanged",
        "type": "event",
    },
    {
        "anonymous": false,
        "inputs": [
            { "indexed": true, "internalType": "uint256", "name": "newRatio", "type": "uint256" },
            { "indexed": true, "internalType": "uint256", "name": "totalValueLocked", "type": "uint256" },
        ],
        "name": "LatestRatioUpdated",
        "type": "event",
    },
    {
        "anonymous": false,
    ...
    },
    {
        ...
        "inputs": [
            { "indexed": true, "internalType": "address", "name": "receiver", "type": "address" },
            { "indexed": true, "internalType": "uint256", "name": "shares", "type": "uint256" },
            { "indexed": true, "internalType": "uint256", "name": "assets", "type": "uint256" },
        ],
    ...
    {
        "anonymous": false,
        "inputs": [{ "indexed": false, "internalType": "address", "name": "newTraderAddress", "type": "address" }],
        "name": "TraderRoleChanged",
        "type": "event",
    },
    {
        "anonymous": false,
    ...
    {
        "inputs": [{ "internalType": "uint256", "name": "totalAssets", "type": "uint256" }],
    ...
    },
    {
        "inputs": [
            ...
            { "internalType": "uint256", "name": "requestsToProcess", "type": "uint256" },
        ],
        "name": "processRequests",
        "outputs": [],
        "stateMutability": "nonpayable",
    ...
    },
    {
        "inputs": [],
        "name": "reduxWhitelist",
        "outputs": [{ "internalType": "contract ReduxWhitelist", "name": "", "type": "address" }],
        "stateMutability": "view",
        "type": "function",
    },
    {
    ...
    },
    {
        ...
        "outputs": [{ "internalType": "uint256", "name": "totalDepositedAssets", "type": "uint256" }],
        "stateMutability": "view",
        "type": "function",
    },
    {
        "inputs": [{ "internalType": "uint256", "name": "totalAssets", "type": "uint256" }],
        "name": "requestedRedeemAssets",
        "outputs": [{ "internalType": "uint256", "name": "requiredAssets", "type": "uint256" }],
        "stateMutability": "view",
        "type": "function",
    },
    {
    ...
    {
        "inputs": [{ "internalType": "address", "name": "newDepositAddress", "type": "address" }],
    ...
    {
        "inputs": [{ "internalType": "address", "name": "newGovController", "type": "address" }],
        "name": "setGovernanceController",
        "outputs": [],
        "stateMutability": "nonpayable",
        "type": "function",
    },
    {
        "inputs": [{ "internalType": "address", "name": "newTraderAddress", "type": "address" }],
        "name": "setTraderRole",
        "outputs": [],
        "stateMutability": "nonpayable",
        "type": "function",
