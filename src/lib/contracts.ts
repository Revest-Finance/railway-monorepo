...
import { fnftHandlerABI, outputReceiverABI, priceProviderABI, reduxABI, resonateABI, tokenVaultABI } from "./abi";
import {
    E6_addresses,
    PROVIDERS,
...
export const isE6 = (asset: string, chainid: number): boolean => {
    return E6_addresses[chainid].includes(getAddress(asset));
};
...
export const redux_cex_contract: { [chainId: number]: Contract | null } = {
    1: null,
    10: null,
    137: null,
    250: null,
    42161: new Contract("0x1A0EeAa7BF60E01646eff96BfCAaDa850eD250aE", reduxABI, PROVIDERS[42161]),
    31337: null,
};
